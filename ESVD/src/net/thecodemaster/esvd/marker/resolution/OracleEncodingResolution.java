...
public class OracleEncodingResolution extends AbstractEncodingResolution {

	private static final String	ESAPI_IMPORT					= "org.owasp.esapi.ESAPI";
	private static final String	ORACLE_CODEC_IMPORT		= "org.owasp.esapi.codecs.OracleCodec";
	private static final String	ORACLE_CODEC_INSTANCE	= "new OracleCodec()";
	...
	public void run(IMarker marker) {
		try {
			...
			listImport.add(ORACLE_CODEC_IMPORT);
	...
	protected void generateEncoding(CompilationUnit cUnit, IDocument document, int offset, int length)
		...
		args.add(0, (Expression) astRewrite.createStringPlaceholder(ORACLE_CODEC_INSTANCE, ASTNode.CLASS_INSTANCE_CREATION));
